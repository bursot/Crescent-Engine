...
Material::Material(const std::string& name)
    ...
    , m_LodFadeEnabled(false)
    , m_LodFadeStart(0.0f)
    , m_LodFadeEnd(0.0f)
    , m_DitherEnabled(true)
    , m_BillboardEnabled(false)
    , m_BillboardStart(0.0f)
    , m_BillboardEnd(0.0f)
    , m_ImpostorEnabled(false)
    , m_ImpostorRows(8)
    , m_ImpostorCols(8)
    , m_TerrainEnabled(false)
    , m_TerrainBlendSharpness(1.0f)
    , m_TerrainHeightStart(0.0f)
    , m_TerrainHeightEnd(8.0f)
    , m_TerrainSlopeStart(0.35f)
    , m_TerrainSlopeEnd(0.85f)
    ...
    , m_TerrainControlTexture(nullptr)
    , m_TerrainLayer0Texture(nullptr)
    , m_TerrainLayer1Texture(nullptr)
    , m_TerrainLayer2Texture(nullptr)
    , m_TerrainLayer0NormalTexture(nullptr)
    , m_TerrainLayer1NormalTexture(nullptr)
    , m_TerrainLayer2NormalTexture(nullptr)
    , m_TerrainLayer0ORMTexture(nullptr)
    , m_TerrainLayer1ORMTexture(nullptr)
    , m_TerrainLayer2ORMTexture(nullptr)
    , m_UVTiling(1.0f, 1.0f)
    , m_UVOffset(0.0f, 0.0f)
    , m_TerrainLayer0Tiling(1.0f, 1.0f)
    , m_TerrainLayer1Tiling(1.0f, 1.0f)
    , m_TerrainLayer2Tiling(1.0f, 1.0f)
    , m_NormalScale(1.0f)
    , m_HeightScale(0.02f)
